...
public class EmployeeFactory {
    ...
    public List<Employee> getAllEmployee(){
        ...
        employees.add(new Employee("2017Emp0234", "María Luisa", "Pastor", 900000, 1, Arrays.asList(delta, beta)));
        ...
        employees.add(new Employee("2022Emp0087", "Pepito", "Lopez", 900000, 1, of(twoFactorAuth)));
        employees.add(new Employee("2019Emp0050", "Vicenta", "Estévez", 1300000, 1, Arrays.asList(removeUsers, commonUI)));
        employees.add(new Employee("2023Emp0934", "Agapito", "Abel", 1100000, 1, of(pegasus)));
        employees.add(new Employee("2023Emp1033", "Faustino", "Garcia", 1200000, 0, of(delta)));
